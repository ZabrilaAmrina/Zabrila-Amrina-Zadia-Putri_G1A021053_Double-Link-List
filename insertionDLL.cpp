...
int main()
{
	...
	// Insert 15 Jadi daftar tertaut akan menjadi 15->NULL
	append(&head, 15);

	// Insert 10 pada awalnya.
	// Jadi daftar tertaut akan menjadi 10->15->NULL
	push(&head, 10);

	// Insert 2 pada awalnya. jadi
	// daftar tertaut akan menjadi 2->10->15->dNULL
	push(&head, 2);

	// Insert 21 pada akhiran. jadi 
	// daftar tertaut akan menjadi 2->10->15->21->NULL
	append(&head, 21);
